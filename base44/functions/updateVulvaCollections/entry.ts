...
const MATCH_RULES = [
  ...
  { keywords: ['niçoise', 'tomate', 'mug'], notKeywords: ['fraise'], col: 'vulva-la-revolution-fr', sort: 1, scene: 'nicoise_tomate' },
  { keywords: ['niçoise', 'carmen', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 2, scene: 'nicoise_fraise_carmen' },
  { keywords: ['niçoise', 'fraise', 'mug'], notKeywords: ['carmen'], col: 'vulva-la-revolution-fr', sort: 3, scene: 'nicoise_fraise' },
  { keywords: ['vulva', 'tomate', 'mug'], notKeywords: ['fraise', 'navet', 'turnip', 'graines', 'woke', 'amour', 'guerre', 'shakira', 'carmen', 'prêts', 'niçoise'], col: 'vulva-la-revolution-fr', sort: 4, scene: 'tomate_vulva_fr' },
  { keywords: ['faites', 'amour', 'tomate', 'mug'], notKeywords: ['fraise', 'navet', 'niçoise'], col: 'vulva-la-revolution-fr', sort: 5, scene: 'tomate_amour_fr' },
  { keywords: ['vulva', 'carmen', 'tonio', 'fraise', 'mug'], notKeywords: ['amour', 'faites', 'shakira', 'rico'], col: 'vulva-la-revolution-fr', sort: 6, scene: 'fraise_vulva_carmen_tonio_fr' },
  { keywords: ['vulva', 'shakira', 'rico', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 7, scene: 'fraise_vulva_shakira_rico_fr' },
  { keywords: ['faites', 'amour', 'carmen', 'tonio', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 8, scene: 'fraise_amour_carmen_tonio_fr' },
  { keywords: ['faites', 'amour', 'carmen', 'shakira', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 9, scene: 'fraise_amour_carmen_shakira_fr' },
  { keywords: ['faites', 'amour', 'rico', 'shakira', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 10, scene: 'fraise_amour_rico_shakira_fr' },
  { keywords: ['faites', 'amour', 'rico', 'tonio', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 11, scene: 'fraise_amour_rico_tonio_fr' },
  { keywords: ['faites', 'amour', 'lola', 'almarita', 'fraise', 'mug'], col: 'vulva-la-revolution-fr', sort: 12, scene: 'fraise_amour_lola_almarita_fr' },
  { keywords: ['graines', 'mug'], notKeywords: ['poster'], col: 'vulva-la-revolution-fr', sort: 13, scene: 'graines_fr' },
  { keywords: ['vulva', 'navet', 'mug'], notKeywords: ['couple', 'prêts'], col: 'vulva-la-revolution-fr', sort: 14, scene: 'navet_vulva_solo_fr' },
  { keywords: ['prêts', 'woke', 'navet', 'mug'], col: 'vulva-la-revolution-fr', sort: 15, scene: 'navet_woke_fr_new' },
  ...
  // Niçoise ni Soumise en premier
  { keywords: ['niçoise', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 1 },
  { keywords: ['niçoise', 'carmen', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 2 },
  { keywords: ['niçoise', 'fraise', 'poster'], notKeywords: ['carmen'], col: 'posters-vulva-la-revolution-fr', sort: 3 },
  { keywords: ['vulva', 'tomate', 'poster'], notKeywords: ['navet', 'fraise', 'turnip', 'couple', 'niçoise'], col: 'posters-vulva-la-revolution-fr', sort: 4 },
  { keywords: ['anti patriarcat', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 5 },
  { keywords: ['toustes ensemble', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 6 },
  { keywords: ['faites', 'amour', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 7 },
  { keywords: ['prêts pour le woke', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 8 },
  { keywords: ['misandrie', 'misoginie', 'tomate', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 9 },
  { keywords: ['vulva', 'carmen', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 10 },
  { keywords: ['anti patriarcat', 'tonio', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 11 },
  { keywords: ['vulva', 'shakira', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 12 },
  { keywords: ['anti patriarcat', 'rico', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 13 },
  { keywords: ['faites', 'amour', 'carmen', 'fraise', 'poster'], notKeywords: ['tonio', 'shakira', 'rico', 'lola', 'almarita'], col: 'posters-vulva-la-revolution-fr', sort: 14 },
  { keywords: ['pas la guerre', 'tonio', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 15 },
  { keywords: ['faites', 'amour', 'rico', 'fraise', 'poster'], notKeywords: ['shakira', 'tonio'], col: 'posters-vulva-la-revolution-fr', sort: 16 },
  { keywords: ['pas la guerre', 'shakira', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 17 },
  { keywords: ['faites', 'amour', 'lola', 'fraise', 'poster'], notKeywords: ['almarita'], col: 'posters-vulva-la-revolution-fr', sort: 18 },
  { keywords: ['pas la guerre', 'almarita', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 19 },
  { keywords: ['toustes ensemble', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 20 },
  { keywords: ['faites', 'amour', 'carmen', 'tonio', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 21 },
  { keywords: ['faites', 'amour', 'rico', 'shakira', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 22 },
  { keywords: ['faites', 'amour', 'lola', 'almarita', 'fraise', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 23 },
  { keywords: ['prêts', 'woke', 'poivron', 'courgette', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 24 },
  { keywords: ['graines', 'poster'], notKeywords: ['mug'], col: 'posters-vulva-la-revolution-fr', sort: 25 },
  { keywords: ['brisé la boîte', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 26 },
  { keywords: ['ci vis pacem', 'poster'], notKeywords: ['mug', 'en'], col: 'posters-vulva-la-revolution-fr', sort: 27 },
  { keywords: ['enc', 'poster'], notKeywords: ['mug'], col: 'posters-vulva-la-revolution-fr', sort: 28 },
  { keywords: ['carotter', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 29 },
  { keywords: ['vulva', 'navet', 'couple', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 30 },
  { keywords: ['vulva', 'navet', 'poster'], notKeywords: ['couple', 'prêts', 'anti'], col: 'posters-vulva-la-revolution-fr', sort: 31 },
  { keywords: ['anti patriarcat', 'navet', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 32 },
  { keywords: ['prêts', 'woke', 'navet', 'poster'], col: 'posters-vulva-la-revolution-fr', sort: 33 },
